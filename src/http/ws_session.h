#ifndef __TAO_HTTP_WS_SESSION_H__
#define __TAO_HTTP_WS_SESSION_H__
...
namespace tao {
namespace http {
#pragma pack(1)//without any padding:
struct WSFrameHead {
    enum OPCODE {
        /// Data fragment frame
        CONTINUE = 0,
...
extern tao::ConfigVar<uint32_t>::ptr g_websocket_message_max_size;
