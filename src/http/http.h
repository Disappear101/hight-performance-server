...
/**
 * convert from string to http method
 **/
...
/**
 * status enum to description
*/
const char* HttpStatusToString(const HttpStatus& s);

/**
 * get value by key and cast into speficied type 
*/
...
public:
    ...
    /**
     * version
     * close: close keepalive
     **/
    HttpRequest(uint32_t version = 0x11, bool close = true);
    ...
    std::string getParam(const std::string& key, const std::string& def = std::string());

    std::string getCookie(const std::string& key, const std::string& def = std::string());
    
    /**
     * set Header params(key, val)
    */
    ...
    /**
     * check and get params of http headers
    */
    template<class T>
...
private:
    ...
    uint8_t m_version;
    //whether automatocally close(short/long connection)
    bool m_close;
